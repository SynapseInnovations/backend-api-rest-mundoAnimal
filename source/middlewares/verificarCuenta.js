...
const CantidadDeCuenta = async(req, res, next) =>{
      try{
            const MaximaCantidadCuentaActivas = 10
            ...
            if (cantidadUsuariosActivos >= MaximaCantidadCuentaActivas) {
                  console.error(`Se ha excedido el límite de cuentas activas. (Activas: ${cantidadUsuariosActivos}, Límite: ${MaximaCantidadCuentaActivas})`);
